...
#
# Licensed under the Apache License, Version 2.0 (the "License");# Import necessary modules
from diffusers.schedulers.config import register_to_config

order = 1

@register_to_configyou may not use this file except in compliance with the License.
