...
import abc
from typing import Any, Callable, Dict, List, Optidef get_word_inds(text, word, tokenizer):
    # Implementation of get_word_inds function
    pass

def get_replacement_mapper_(x, y, tokenizer, max_len):
    words_x = x.split(" ")
    words_y = y.split(" ")
...
def get_word_inds(text, word, tokenizer):
    # Implementation of get_word_inds function
    pass
...
class ScoreParams:
    def __init__(self, gap, match, mismatch):
        self.gap = gap
        self.match = match
        self.mismatch = mismatchnn.functional as F
